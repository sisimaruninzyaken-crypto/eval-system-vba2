...
Sub ADL_Load_SmokeTest()
    Dim ws As Worksheet, c As Long, r As Long
    Dim sOrig As String, sTest As String
    Dim filledBefore As Long, totalTagged As Long
    Dim filledAfter As Long, dummy As String
    ...
    ' サンプル27ペア（値は適当文字でOK：UIが空でないことだけ確認する）
    sTest = "BITotal=55|BI_0=自立|BI_1=要介助|BI_2=可|BI_3=不可|BI_4=△|BI_5=○|BI_6=×|BI_7=要監視|BI_8=良|BI_9=可|" & _
            "IADL_0=可|IADL_1=可|IADL_2=不可|IADL_3=△|IADL_4=○|IADL_5=×|IADL_6=要支援|IADL_7=可|IADL_8=可|" & _
            "IADLNote=テスト|" & _
            "Kyo_Roll=可|Kyo_SitUp=可|Kyo_SitHold=△|Kyo_StandUp=○|Kyo_StandHold=×|Kyo_Note=テスト"
...
Sub ADL_Load_SmokeTest_ListOnly()
    Dim ws As Worksheet, c As Long, r As Long
    Dim sOrig As String, sTest As String
    ...
    ' すべてリスト内値で作成
    sTest = "BITotal=55|" & _
            "BI_0=自立|BI_1=見守り（監視下）|BI_2=一部介助|BI_3=全介助|BI_4=自立|BI_5=見守り（監視下）|BI_6=一部介助|BI_7=全介助|BI_8=自立|BI_9=見守り（監視下）|" & _
            "IADL_0=自立|IADL_1=見守り（監視下）|IADL_2=一部介助|IADL_3=全介助|IADL_4=自立|IADL_5=見守り（監視下）|IADL_6=一部介助|IADL_7=全介助|IADL_8=自立|" & _
            "IADLNote=テスト|" & _
            "Kyo_Roll=自立|Kyo_SitUp=見守り（監視下）|Kyo_SitHold=一部介助|Kyo_StandUp=全介助|Kyo_StandHold=自立|Kyo_Note=テスト"
